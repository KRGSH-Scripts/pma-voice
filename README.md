...
| voice_enableMicMute        | 1       | Enables `/togglemicmute` and the mic mute key binding (`0` disables).                                                                                                                  | int          |
| voice_defaultMicMuteKey    | M       | Default key to toggle your own microphone transmit mute. Change in FiveM Key Bindings → FiveM.                                                                                        | string       |
